...
function generateShapes() {
  ...
  return techs.map((tech, i) => {
    ...
    return {
      ...
      y: window.innerHeight - HEADER_HEIGHT - (70 + tech.adjustY),
      rotation: 0,
      isDragging: false,
      color: tech.color,
      path: tech.path,
